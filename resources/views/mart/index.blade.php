    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div class="card p-8 rounded-md bg-white shadow-md">
            ...
            <div class="card-bottom mt-4">
                <h1 class="font-bold text-2xl">{{ format_to_rp(1242500) }}</h1>
                <p class="text-zinc-500 text-base">Total Transactions</p>
            </div>
        </div>
        <div class="card p-8 rounded-md bg-white shadow-md">
            <div class="card-top flex justify-between items-center relative">
            ...
            <div class="card-bottom mt-4">
                <h1 class="font-bold text-2xl">{{ count($products) }}</h1>
                <p class="text-zinc-500 text-base">Total Products</p>
            </div>
        </div>
        ...
        <div class="card p-8 rounded-md bg-white shadow-md">
            <div class="card-top flex justify-between items-center relative">
                ...
                {{-- <div
                    class="notif flex items-center gap-1 bg-[#003034] text-white px-3 py-2 absolute top-0 right-0 text-xs rounded-2xl">
                    32%
            ...
            <div class="card-bottom mt-4">
                <h1 class="font-bold text-2xl">{{ count($categories) }}</h1>
                <p class="text-zinc-500 text-base">Total Categories</p>
            </div>
        </div>
    </div>
    {!! $charts->container() !!}
