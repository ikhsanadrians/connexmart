...
@section('content')
    <div class="headers flex justify-between">
        ...
        <div class="option-right flex items-center gap-2">
            ...
            <div class="print flex items-center gap-2 border-[#303fe2] border-[1.5px] text-[#303fe2] py-2 px-4 rounded-lg">
                <p>
                    Print
                </p>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="transactions pb-12">
        <div
            class="card mt-2 lg:mt-3 rounded-lg  border-b-[1.2px]  border-gray-200 relative py-2 px-1 lg:px-5 bg-white shadow-sm">
