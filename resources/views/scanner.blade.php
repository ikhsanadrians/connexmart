...
@section('content')
    <div class="scanner flex flex-col justify-center  overflow-y-hidden h-full pb-16">
        ...
        <div class="scanner-option flex justify-center gap-4 h-fit py-4 overflow-y-hidden mt-3">
            <div
                class="camera-option p-4 h-fit bg-white  shadow-md rounded-lg flex flex-col gap-2 justify-center items-center w-fit">
            ...
            <div
                class="type-code p-4 h-fit  shadow-md gap-2 rounded-lg flex flex-col justify-center items-center w-fit  bg-white">
                <span class="material-symbols-rounded text-[#303fe2] text-[35px]">
                    pin
                </span>
