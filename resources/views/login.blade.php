...
<body class="bg-zinc-100">
    <header class="px-4 lg:px-8 py-3 bg-gradient-to-r from-[#303fe2] to-blue-500 text-white shadow-md w-full">
        ...
        <div id="form-wrappers" class="form-wrappers w-full px-4 mt-8 bg-white lg:w-1/3  shadow-lg py-8 rounded-2xl">
            ...
            <form method="POST" action="{{ route('auth') }}"
                ...
                <div class="inputs w-full">
                    ...
                    <div class="action-rememberme flex items-center gap-2 mt-3 text-sm text-slate-600">
                        <input value="is_remember" type="checkbox" name="remember_me" id="remember">
                        <p>Ingat Saya</p>
                    </div>
                </div>
