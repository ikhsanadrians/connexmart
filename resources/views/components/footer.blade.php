    ...
    <div
        ...
        <div class="company">
            <div class="icon flex items-center gap-2">
                <img src="{{ asset('images/static/tenizenmart.png') }}" alt="connexmart" class="h-8">
                <p class="font-semibold text-[#303fe2]">Tenizen Mart</p>
            </div>
        ...
        <div class="menu mb-8 flex lg:flex-row flex-col gap-8 lg:gap-16">
            <ul class="flex flex-col gap-3 lg:text-base text-sm">
                ...
                <li class="text-slate-600">Syarat Dan Ketentuan</li>
                <li class="text-slate-600">Kebijakan Privasi</li>
                <li class="text-slate-600">Hak Cipta</li>
                <li class="text-slate-600">Tentang Kami</li>
                <li class="text-slate-600">Press</li>
                <li class="text-slate-600">TenizenBank</li>
                <li class="text-slate-600">TenizenExpress</li>
            </ul>
            <ul class="flex flex-col gap-3 lg:text-base text-sm">
                <li class="font-semibold">Beli</li>
                <li class="text-slate-600">Es Krim</li>
                <li class="text-slate-600">Snack</li>
                <li class="text-slate-600">Minuman</li>
                <li class="text-slate-600">Makanan</li>
                <li class="text-slate-600">Alat Tulis</li>
                <li class="text-slate-600">Odeng</li>
                <li class="text-slate-600">Gorengan</li>
            </ul>
            <ul class="flex flex-col gap-3 lg:text-base text-sm">
            ...
            <ul>
                <ul>
                    ...
                    <div class="social-media flex mt-3 gap-3">
                        <svg width="30px" height="30px" viewBox="0 0 1024 1024" data-aut-id="icon"
                            class="fill-[#303fe2]" fill-rule="evenodd">
