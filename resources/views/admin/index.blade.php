...
@section('content')
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    <div class="card p-8 rounded-md bg-white shadow-md">
        ...
        <div class="card-bottom mt-8">
            <h1 class="font-bold text-xl">123</h1>
  ...
  <div class="grid grid-cols-2 gap-4 mt-8">
    ...
    <div class="report relative bg-gradient-to-r p-6 shadow-md from-[#003034] to-gray-800 h-full rounded-md">
        ...
        <div class="button absolute right-4 bottom-4 border-[1.5px] px-3 py-1 rounded-md cursor-pointer border-gray-500 text-white flex items-center gap-2">
